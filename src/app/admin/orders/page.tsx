        ...
        <div className="p-8">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Manage orders across all stores</p>
                </div>
            </div>
            ...
            <div className="flex gap-6">
                            ...
                            <table className="w-full">
                                <thead className="bg-gray-50 border-b border-gray-100">
                                    <tr>
                                        ...
                                        <th className="text-left px-6 py-4 text-sm font-medium text-gray-500">Fulfillment</th>
                                ...
                                <tbody>
                                    {orders.map((order) => (
                                        <tr
                                            key={order.id}
                                            className={`border-b border-gray-100 hover:bg-gray-50 cursor-pointer ${selectedOrder?.id === order.id ? 'bg-green-50' : ''}`}
                ...
                {/* Order Detail Panel */}
                {selectedOrder && (
                    <div className="w-96 bg-white rounded-xl border border-gray-100 p-6 h-fit sticky top-8">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-lg font-semibold text-gray-900">Order #{selectedOrder.order_number}</h2>
                            <button
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-gray-900">{selectedOrder.customer_name || 'Guest'}</p>
