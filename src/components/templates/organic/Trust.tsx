    ...
    badges = [
        {
            ...
            description: 'Independently tested for over 270+ banned substances. Trusted by Olympic and professional athletes worldwide.',
            icon: 'shield',
        },
        {
            name: 'ISO 17025 Accredited',
            description: 'Our lab testing meets the highest international standards for accuracy and reliability.',
            icon: 'beaker',
        },
        {
            name: 'GMP Certified Facility',
            description: 'Manufactured in an FDA-registered facility following strict Good Manufacturing Practices.',
            icon: 'check',
        },
        {
            name: 'Made in USA',
            description: 'Produced in our Georgia, USA facility with domestic ingredients for quality control.',
            icon: 'flag',
        },
    ],
        ...
        <section className="section" style={{ background: 'var(--color-background)' }}>
            <div className="container">
                ...
                <div className="text-center max-w-2xl mx-auto mb-12">
                    ...
                    >
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" style={{ color: 'var(--color-primary)' }}>
                            <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span className="font-semibold" style={{ color: 'var(--color-primary)' }}>Third-Party Verified</span>
                    </div>
                ...
                <div
                    className="mt-12 p-6 rounded-2xl max-w-2xl mx-auto text-center"
                    style={{
                ...
                <div className="mt-12 text-center">
                    ...
                    >
                        ...
                        Watch Our Scale Test Challenge
                    </button>
                </div>
            </div>
        </section>
